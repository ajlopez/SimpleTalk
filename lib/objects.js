...
const BlockClass = new ClassObject('Block', null, [ 'localVarNames', 'bytecodes' ], [], false);
...
function BlockObject(locals, bytecodes) {
    BaseObject.call(this);
    
    this.class(BlockClass);
    
    this.put(0, createValueObject(locals));
    this.put(1, createValueObject(bytecodes));
}
...
BlockObject.prototype.localVarNames = function () { return this.get(0); };
BlockObject.prototype.bytecodes = function () { return this.get(1); };

function createBlockObject(locals, bytecodes) {
    return new BlockObject(locals, bytecodes);
}
